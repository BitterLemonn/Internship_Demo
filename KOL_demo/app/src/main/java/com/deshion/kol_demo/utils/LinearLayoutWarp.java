...
public class LinearLayoutWarp extends ViewGroup {

    private Type mType;
    private List<WarpLine> mWarpLineGroup;

    public LinearLayoutWarp(Context context) {
        super(context);
    }

    public LinearLayoutWarp(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.style.WarpLinearLayoutDefault);
    }

    public LinearLayoutWarp(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private final static class Type {
        ...
        Type(Context context, AttributeSet attrs) {
            ...
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.LinearLayoutWarp);
            grivate = typedArray.getInt(R.styleable.LinearLayoutWarp_grivate, grivate);
            horizontal_Space = typedArray.getDimension(R.styleable.LinearLayoutWarp_horizontal_Space, horizontal_Space);
            vertical_Space = typedArray.getDimension(R.styleable.LinearLayoutWarp_vertical_Space, vertical_Space);
            isFull = typedArray.getBoolean(R.styleable.LinearLayoutWarp_isFull, isFull);
        }
    }
